...
const DoctorList = () => {
  const { doctors, getAllDoctors, authToken, changeDoctorAvailability } =
    ...
    <section className="w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-5">
        {doctors && doctors.length > 0 ? (
              ...
              <div className="px-4 py-3 bg-gradient-to-b from-[#eef3ff] to-[#e5f0ff] group-hover:to-[#cbe8ff] transition-all duration-300">
                <div className="flex items-start justify-between gap-2">
                  <div className="flex-1">
                    ...
                    <div className="w-full mt-2 flex items-center gap-4 text-xs">
                      <div className="flex items-center gap-1">
                        ...
                        />
                        <span className="ml-1 text-gray-600">Available</span>
                      </div>
                      {/* <span className="text-gray-600">{doctor.experience} y</span>
          ...
          // if doctors is null, undefined, or empty, show no doctors message
